...
const About = () => {
    ...
    return (
        <>
            <div id="about" className=" pt-36 px-8 py-12 bg-gray-800 h-screen sm:flex-col sm:items-center md:items-center sm:gap-8 md:gap-8 " >
                ...
                <div className="w-full md:w-1/2 flex ">
                    <TypewriterEffect words={words} className="!text-4xl text-gray-300 font-mono h-12 w-screen flex float-left sm:text-4xl" />
                </div>
